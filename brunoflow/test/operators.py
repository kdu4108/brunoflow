...
utils.add_tests(
    ...
    inputs=utils.random_inputs(unary_input_shapes, rand=lambda size: np.random.randint(-5, 5, size=size)),
    test_backward=False,
)
...
utils.add_tests(
    ...
    fn=lambda x, y: x & y,
    torch_fn=lambda x, y: torch.tensor(x.numpy() & y.numpy()),
    inputs=utils.random_inputs(binary_input_shapes, rand=lambda size: np.random.randint(-5, 5, size=size)),
    test_backward=False,
)
