...
utils.add_tests(
    ...
    inputs=utils.random_inputs(unary_input_shapes, rand=lambda size: 2 * np.random.random(size=size) - 1),
)
...
utils.add_tests(
    ...
    inputs=utils.random_inputs(binary_input_shapes, rand=lambda size: 2 * np.random.random(size=size) - 1),
)
...
utils.add_tests(
    ...
    torch_fn=lambda x: torch.log(x + torch.sqrt(x * x - 1)),
    inputs=utils.random_inputs(unary_input_shapes, rand=lambda size: 1 + np.random.random(size=size)),
)
