...
utils.add_tests(
    ...
    inputs=utils.random_inputs([[(4)], [(3, 4)], [(5, 4, 3)]]),
)
...
utils.add_tests(
    ...
    inputs=utils.random_inputs([[(8)], [(4, 4)], [(5, 4, 2)]]),
)
...
utils.add_tests(
    ...
    inputs=utils.random_inputs([[(4, 1)], [(1, 4)], [(5, 1, 3)], [(1, 3, 1, 5)]]),
)
...
utils.add_tests(
    ...
    inputs=utils.random_inputs([[(4)], [(3, 4)], [(1, 3)], [(3, 5, 1)]]),
)
...
utils.add_tests(
    ...
    inputs=utils.random_inputs([[(4), (4), (4)], [(3), (4)]]),
)
...
utils.add_tests(
    ...
    inputs=utils.random_inputs([[(4, 2), (4, 5), (4, 3)]]),
)
...
utils.add_tests(
    ...
    inputs=utils.random_inputs([[(3, 1)]]),
)
...
utils.add_tests(
    ...
    inputs=utils.random_inputs([[(3), (3), (3), (3)]]),
)
...
utils.add_tests(
    ...
    inputs=utils.random_inputs([[(9)], [(9, 2)]]),
)
...
utils.add_tests(
    ...
    inputs=utils.random_inputs([[(5, 3)], [(5, 2, 3)]]),
)
